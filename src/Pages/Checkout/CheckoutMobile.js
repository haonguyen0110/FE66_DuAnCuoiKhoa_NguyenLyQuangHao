        ...
        <div className=" mt-5 mx-5" style={{ minHeight: '100vh' }}>
            <div className=" ">
                ...
                <div className=" shadow-2xl px-5 py-5">
                    <h1 className="text-2xl text-green-500">THÔNG TIN VÉ ĐÃ CHỌN</h1>
                    <div className="my-5 w-4/5" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
                        <div className="w-full">
                            <span className="text-red-500 font-bold text-lg mr-3">Ghế đã chọn</span>
                    ...
                    <hr />
                    <div>
                        <span className="text-red-500 font-bold text-lg mr-3">Tổng tiền</span>
                        <span className="text-xl text-green-600 text-center">
        ...
        <section className="text-gray-600 body-font flex items-center justify-center">
            <div className="container ml-auto flex px-5 py-10 md:flex-row flex-col items-center justify-center">
                ...
                <div className="lg:flex-grow md:w-1/2 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium sm:mt-0 text-gray-900">{`${chiTietPhongVe.thongTinPhim.tenPhim}`}
...
export default function CheckoutTab(props) {
    ...
    return <div className="p-5 movie">
